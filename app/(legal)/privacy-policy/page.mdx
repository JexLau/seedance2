# Privacy Policy for seedance2

## Introduction

Welcome to seedance2, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At seedance2, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using seedance2:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use seedance2, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access seedance2, such as device type, operating system, and browser type.
...
**Copyright Owner**: [seedance2.site](http://seedance2.site)
**Email**: [support@seedance2.site](mailto:support@seedance2.site)

By using seedance2, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
